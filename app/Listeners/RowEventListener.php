...
class RowEventListener implements ShouldQueue
{
    /**
    ...
    public function twentyBonus($user_id, $pid, $money, $award)//二十代奖金
    {
        ...
        try {
            ...
            $user->account=$user->account+$award;
            $user->bonus=$user->bonus+$award;
            $userRes=$user->save();
            if ($userRes) {
