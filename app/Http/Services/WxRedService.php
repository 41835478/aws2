...
$data['mch_id'] = '1352616702';


$data['mch_billno'] = '1352616702'.date("Ymd",time()).date("His",time()).rand(1111,9999);
$data['nonce_str'] = self::createNoncestr();
$data['re_openid'] = $arr['openid'];
$data['wxappid'] = 'wxe259aedad693d781';
...
function trimString($value)
  ...
  public function getSign($Obj)
  {
    ...
    //签名步骤二：在string后加入KEY
    $String = $String."&key="."877e701db74d76616d6cebd5aebc0caf"; // 商户后台设置的key
  ...
  public function xmlToArray($xml)
  {
   ...
   public function wxHttpsRequestPem( $vars,$url, $second=30,$aHeader=array()){
        ...
        curl_setopt($ch,CURLOPT_CAINFO,public_path().'/cert/rootca.pem');
