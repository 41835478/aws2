...
class ShopController extends Controller{
    ...
    public function __construct(RowCommonService $rowCommonService,LimitPayService $limitPayService)
    {
        ...
        if($order_id){
            ...
            if(!empty(session('cart_id'))){
                ...
                foreach($carts as $k=>$v){
                    ...
                    DB::table(self::GOODS)->where(['id'=>$v->goods_id])->decrement('storage',abs($v->num));
                    $goods_num += abs($v->num);
                }
...
//        getChildenAll(1,$users,1);exit;
    ...
    public function paySuccess(){
        return view('home.shop.paySuccess');
    }
    ...
    public function rankingList(){
        ...
        return view('home.shop.rankingList',$return);
    }
