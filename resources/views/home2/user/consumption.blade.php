...
<div class="account_bottom">
	...
	<div class="account_body account_income">
		<ul class="CP_income">
		 @foreach ($sintegral as $v)
			 <li class="act_list">
				<img src="http://www.tjzbdkj.com/home/images/act_icon06.png" alt="">
				<div class="act_class">
	...
	<div class="account_body account_pay" style="display:none">
		<ul class="CP_pay">
			 ...
			 <li class="act_list">
				<img src="http://www.tjzbdkj.com/home/images/act_icon11.png" alt="">
				<div class="act_class">
					<p class="top_p">{{$v['points_info']}}</p>
					<p class="time">{{date('Y-m-d H:i:s',$v['create_at'])}}</p>
				</div>
...
<footer class="footer btn_foot account_foot">
	<a href="{{url('users/turnmyintegral',['id'=>2])}}" class="rci_btn" href="javascript:void(0);">去转账</a>
</footer>
<script>
