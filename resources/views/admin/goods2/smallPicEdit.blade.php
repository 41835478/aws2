            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <div class="ibox-tools">
                        ...
                        @else
                            <a class="collapse-link btn btn-outline btn-success" href="{{url('admin2/goods/goodsAreaList')}}">
                                返回
                            </a>
                        @endif
                    </div>
                ...
                <div class="ibox-content">
                    ...
                    <h2>修改商品轮播图</h2>
                    <form method="post" class="form-horizontal" action="{{url('admin2/goods/editSmallPic')}}" enctype="multipart/form-data">
...
<script type="text/javascript">
    $('.smallPicDel').click(function(){
        ...
        $.ajax({
            'url':'{{url("admin2/goods/delSmallPic")}}',
            'data':{'id':id,'pic':pic},
            'async':true,
            'type':'get',
            'dataType':'json',
