        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="{{url('discRow/index')}}" method="get">
                        <div class="input-group">
                            ...
                            <span  style="float: right;margin-left: 10px;margin-right: 10px;">请选择等级：
                                <select name="level" class="input-sm">
                                    ...
                                    <option value="9" {{request()->level==9?'selected':''}}>9 级</option>
                                    <option value="10" {{request()->level==10?'selected':''}}>10 级</option>
                                    <option value="11" {{request()->level==11?'selected':''}}>11 级</option>
                                    <option value="12" {{request()->level==12?'selected':''}}>12 级</option>
                                </select>
                            </span>
                            <span  style="float: right;margin-left: 10px;margin-right: 10px;">请选择代数：
                                <select name="generate" class="input-sm">
                                    ...
                                    <option value="9" {{request()->generate==9?'selected':''}}>9 代</option>
                                    <option value="10" {{request()->generate==10?'selected':''}}>10 代</option>
                                    <option value="11" {{request()->generate==11?'selected':''}}>11 代</option>
                                    <option value="12" {{request()->generate==12?'selected':''}}>12 代</option>
                                </select>
                            </span>
