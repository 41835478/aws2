        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>系统公告列表 <span style="margin-left: 10px;margin-right: 10px;">|</span> <a  href="{{url('banner/noticeadd')}}" class="diva"  style="height:22px;line-height:14px;" >添加系统公告</a> </h5>
                </div>
                    ...
                    <table class="footable table table-stripped" data-page-size="10" data-filter=#filter>
                        ...
                        @foreach ($banner as $v)
                            <tr class="gradeX">
                                ...
                                <td class="center">
                                    <a href="{{url('banner/noticeedit',array('id'=>$v->id))}}">修改</a> |
