...
<div class="col-sm-12">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <form method="post" class="form-horizontal" action="{{url('user/actEditInfo')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="mobile" placeholder="{{$first->mobile}}">
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <img id="img" style="border: 1px dashed #c0c0c0" src="{{$first->pic?asset($first->pic):'/uploads/adminPic/a6.jpg'}}" width="100px" height="100px">
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
...
<script type="text/javascript" src="{{asset('admin/editor/kindeditor.js')}}"></script>
