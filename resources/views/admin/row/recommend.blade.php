        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form action="{{url('row/recommend')}}" method="get">
                        <div class="input-group">
                            ...
                            <span  style="float: right;margin-left: 10px">奖金：
                                <input name="money" type="text" value="{{request()->money}}" class="input-sm" placeholder="请输入奖金"/>
                            </span>
                    ...
                    <table class="footable table table-stripped" data-page-size="10" data-filter=#filter>
                        ...
                        <tr>
                            ...
                            <td colspan="11">
                                {!! $date->appends(['from_phone'=>request()->from_phone,'to_phone'=>request()->to_phone,'money'=>request()->money])->links() !!}
                            </td>
                        </tr>
                        </tfoot>
                    </table>
